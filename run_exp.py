...
#    win = visual.Window(color='white', fullscr=True)
        ...
        if 'space' in keys:
            ...
            while len(response) < len(prompt) and not time_limit_exceeded:  # Add the time_limit_exceeded condition here
                ...
                if trial_clock.getTime() > 20:  # If more than 20 seconds have passed
                    ...
                    msg_stim.draw()
                    win.flip()
                    prompt_timeout=prompt_clock.getTime()
    ...
    with open('results.csv', 'w', newline='') as csvfile:
        fieldnames = ['prompt', 'response', 'correct_keys', 'complexity_level', 'rest_time', 'key_timestamps','keystamp_1', 'keystamp_2', 'keystamp_3', 'keystamp_4', 'keystamp_5', 'prompt_time', 'prompt_timeout','total_time_taken']
